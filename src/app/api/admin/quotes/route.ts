  ...
  try {
    ...
    const quote = await prisma.quote.create({
      data: {
        ...
        developmentCost: developmentCost ? parseFloat(developmentCost) : 0,
        designCost: designCost ? parseFloat(designCost) : 0,
        monthlyHosting: monthlyHosting ? parseFloat(monthlyHosting) : 0,
        monthlyMaintenance: monthlyMaintenance ? parseFloat(monthlyMaintenance) : 0,
        ...
        monthlyRecurring: monthlyRecurring ? parseFloat(monthlyRecurring) : 0,
        yearlyRecurring: yearlyRecurring ? parseFloat(yearlyRecurring) : 0,
      },
      include: {
        client: true,
        project: true,
