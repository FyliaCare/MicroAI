            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <span className="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full w-6 h-6 flex items-center justify-center font-bold animate-pulse border-2 border-white shadow-lg">
              ...
              <Link 
                href="/admin/settings" 
                className="text-gray-600 hover:text-gray-900 hidden sm:block p-2 rounded-md hover:bg-gray-100"
                aria-label="Settings"
                title="Settings"
              >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    pathname === '/admin' ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/quotes') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/projects') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/clients') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 relative ${
                    isActive('/admin/project-requests') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/services') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/blog') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/newsletter') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/chat') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/team') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/time-tracking') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/tasks') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/sales-activities') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/documents') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/receipts') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/expenses') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/analytics') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/activity') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              ...
              <li>
                <Link
                  href="/admin/bot-protection"
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/bot-protection') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/notifications') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
              ...
              <li>
                <Link
                  ...
                  onClick={() => setSidebarOpen(false)}
                  className={`w-full text-left px-4 py-3 rounded-md min-h-[44px] touch-manipulation flex items-center gap-2 ${
                    isActive('/admin/settings') ? 'bg-blue-50 text-blue-600 font-medium' : 'text-gray-600 hover:bg-gray-50'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
